...
- Related docs: `docs/cartaisy/SHOPIFY_API_POLICY.md`, `docs/STATUS.md`, `docs/cartaisy/ROADMAP.md` (Phase 4). GitHub issue: #153. Pull request: recorded with this slice once the PR is open.
