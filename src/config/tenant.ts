...
export const tenantConfig = {
  ...
  shopify: {
    ...
    scopes:
      ...
      'read_products,read_orders,read_customers,write_products,write_orders,write_inventory',
  ...
  security: {
    jwtSecret:
      ...
      'your-super-secret-jwt-key-replace-with-random-string-in-production',
    jwtExpiresIn: process.env.JWT_EXPIRES_IN || '7d',
    rateLimitWindowMs: toNumber(process.env.RATE_LIMIT_WINDOW_MS, 1 * 60 * 1000), // 1 minutes
  ...
  business: {
    ...
    freeShippingThreshold: toFloat(process.env.FREE_SHIPPING_THRESHOLD, 50.0),
    taxRate: toFloat(process.env.TAX_RATE, 0.08), // 8%
    minimumOrderValue: toFloat(process.env.MINIMUM_ORDER_VALUE, 10.0),
