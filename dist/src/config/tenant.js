...
exports.databaseConfig = exports.businessConfig = exports.securityConfig = exports.appConfig = exports.emailConfig = exports.shopifyConfig = exports.apiConfig = exports.storeConfig = exports.derivedConfig = exports.tenantConfig = void 0;
...
exports.derivedConfig = {
    ...
    storeUrl: `https://${exports.tenantConfig.store.domain}`,
    // API endpoints
    apiUrl: `${exports.tenantConfig.api.baseUrl}/api/${exports.tenantConfig.api.version}`,
    // Email signature
    emailSignature: `${exports.tenantConfig.store.name} Team`,
    // Currency formatting
    formatCurrency: (amount) => {
        return `${exports.tenantConfig.business.currencySymbol}${amount.toFixed(2)}`;
    },
    // Deep link URL builder
    buildDeepLink: (path) => {
        return `${exports.tenantConfig.app.deepLinkScheme}://${path}`;
    },
    // Is production environment
    isProduction: exports.tenantConfig.api.nodeEnv === 'production',
    // Is development environment
    isDevelopment: exports.tenantConfig.api.nodeEnv === 'development'
};
// Export individual config sections for easier imports
exports.storeConfig = exports.tenantConfig.store;
exports.apiConfig = exports.tenantConfig.api;
exports.shopifyConfig = exports.tenantConfig.shopify;
exports.emailConfig = exports.tenantConfig.email;
exports.appConfig = exports.tenantConfig.app;
exports.securityConfig = exports.tenantConfig.security;
exports.businessConfig = exports.tenantConfig.business;
exports.databaseConfig = exports.tenantConfig.database;
// Export default
exports.default = exports.tenantConfig;
