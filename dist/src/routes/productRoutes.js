 ...
 * @query {string} category - Category ID filter
 */
router.get('/featured', auth_1.optionalAuth, productController_1.getFeaturedProducts);
/**
 ...
 */
router.get('/recommendations', auth_1.requireAuth, productController_1.getRecommendations);
/**
 ...
 * @query {string} inStock - Filter by stock availability (true/false)
 */
router.get('/category/:categoryId', (0, validation_1.validateObjectId)('categoryId'), productController_1.getProductsByCategory);
/**
 ...
 */
router.get('/:id', (0, validation_1.validateObjectId)('id'), auth_1.optionalAuth, productController_1.getProduct);
/**
 ...
 */
router.get('/:id/reviews', (0, validation_1.validateObjectId)('id'), productController_1.getProductReviews);
/**
 ...
 */
router.get('/:id/related', (0, validation_1.validateObjectId)('id'), productController_1.getRelatedProducts);
/**
 ...
 */
router.post('/:id/track-view', (0, validation_1.validateObjectId)('id'), auth_1.requireAuth, async (req, res) => {
    try {
        await (0, productController_1.trackProductView)(req.params.id, req.user.id, req);
        res.json({
            success: true,
